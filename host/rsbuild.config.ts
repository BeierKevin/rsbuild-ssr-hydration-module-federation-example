  ...
  environments: {
    web: {
      output: {
        ...
        assetPrefix: "http://localhost:4000/client/",
        manifest: true,
        filenameHash: true,
        sourceMap: true,
        // cleanDistPath: true,
      ...
      plugins: [
        pluginModuleFederation({
          dts: false,
          name: "rsbuild_ssr_hydration_host_vue",
          manifest: true,
          filename: "remoteEntry.js",
          remotes: {
            rsbuild_ssr_hydration_remote_vue:
              "rsbuild_ssr_hydration_remote_vue@http://localhost:4001/client/remoteEntry.js",
          },
          shared: {
            vue: {
              eager: true,
      ...
      //         filename: "remoteEntry.js",
      //         remotes: {
      //  rsbuild_ssr_hydration_remote_vue: "rsbuild_ssr_hydration_remote_vue@http://localhost:4001/client/remoteEntry.js",
      //         },
      //         shared: {
      //           vue: {
      //             eager: true,
    ...
    ssr: {
      output: {
        ...
        assetPrefix: "http://localhost:4000/server/",
        // cleanDistPath: true,
        manifest: true,
        filenameHash: true,
        sourceMap: true,
        ...
        rspack: {
          ...
          plugins: [
            new ModuleFederationPlugin({
              ...
              remotes: {
                rsbuild_ssr_hydration_remote_vue:
                  "rsbuild_ssr_hydration_remote_vue@http://localhost:4001/server/remoteEntry.js",
              },
              runtimePlugins: [
                require.resolve("@module-federation/node/runtimePlugin"),
              ],
